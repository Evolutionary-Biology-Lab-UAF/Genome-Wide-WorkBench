...
import sys
from PySide6.QtWidgets import (
    QApplication, QMainWindow, QFileDialog, QPushButton, QVBoxLayout, QHBoxLayout, QWidget, QLabel, QLineEdit, QScrollArea, QCheckBox,QComboBox
,QMessageBox,QTextEdit,QMessageBox)
from PySide6.QtCore import Qt, QSize
from PySide6.QtGui import QFont
import primer3
class Primer3App(QMainWindow):
    def __init__(self):
        super().__init__()
        ...
        # Title label
        self.header_label = QLabel("GenePrimer")
        ...
        # Horizontal layout for file upload components
 ...
 QPushButton {
    ...
    QPushButton:hover {
        ...
        # Add file upload layout to main scroll layout
        ...
        self.default_params = dict(list(self.get_primer3_settings().items())[:15])  # Get only the first 10 parameters
        ...
        for param, value in self.default_params.items():
            ...
            if isinstance(value, bool):
                ...
                line_edit.setStyleSheet("border: 1px solid #2C3E50; border-radius: 5px;")
        ...
        # Run Primer3 button
        self.run_primer_button = QPushButton("Run Primer")
 ...
 QPushButton {
    ...
    def get_primer3_settings(self):
        ...
        "PRIMER_PICK_INTERNAL_OLIGO": 1,  # Enable internal oligo picking  # default is 0
    ...
    def run_primer3(self):
        if not hasattr(self, 'file_path'):
            self.show_error_dialog("No File Selected", "Please load a FASTA file before running Primer Designing app.")
            return
